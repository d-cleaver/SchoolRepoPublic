...
class Story {
  ...
  getHostName() {
    // UNIMPLEMENTED: complete this function! done************when did i do this?
...
class StoryList {
   ...
   */
  // tested functionality of addStory() by:*********************************************
  // in console
  //   let newStory = await storyList.addStory(currentUser,
  //   {title: "Test", author: "Me", url: "http://meow.com"});
  // then
  //   newStory instanceof Story; should return true *************************************
  // 2A
  ...
  // 2A end
  // ***************************************************************************
  // delete newStory from API and remove from StoryList
