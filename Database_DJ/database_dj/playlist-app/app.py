...
##############################################################################
# this route is bugged, add song list form / route does not appear. Tried to adjust the WTForm for it, and got the songs to add list to appear, but they will not add to playlist due to what i believe is a type errror
